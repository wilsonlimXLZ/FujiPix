...
<div class="container">
    <div class="row">
        ...
        <div class="col-4 show-container">
            ...
            <div class="mt-2 mb-1 "><a class="btn btn-outline-info btn-sm" href="{{route('post.edit', $post)}}">Edit Post</a></div>
            <form method ="post" action ="{{route('post.destroy', $post)}}">
                @csrf
                @method('DELETE')
                <input class="btn btn-outline-info btn-sm" type="submit" name="delete" value="Delete Post">
             </form>
